...
CANON_NOTES = [
    # ── Phase 1: 주제 하강 (4분음표) ─────────────────────────────────────────
    (740, _Q), (659, _Q), (587, _Q), (554, _Q),   # F#5 E5  D5  C#5
    (494, _Q), (440, _Q), (494, _Q), (554, _Q),   # B4  A4  B4  C#5

    # ── Phase 2-A: 8분음표 하강+반등 ─────────────────────────────────────────
    (587, _E), (554, _E), (494, _E), (440, _E),   # D5  C#5 B4  A4
    (392, _E), (370, _E), (330, _E), (294, _E),   # G4  F#4 E4  D4
    (330, _E), (370, _E), (392, _E), (440, _E),   # E4  F#4 G4  A4
    (494, _E), (440, _E), (392, _E), (440, _E),   # B4  A4  G4  A4

    # ── Phase 2-B: 아치형 상승 ────────────────────────────────────────────────
    (494, _E), (554, _E), (587, _E), (659, _E),   # B4  C#5 D5  E5
    (587, _E), (554, _E), (494, _E), (554, _E),   # D5  C#5 B4  C#5
    (587, _E), (659, _E), (740, _E), (659, _E),   # D5  E5  F#5 E5
    (587, _E), (554, _E), (494, _E), (440, _E),   # D5  C#5 B4  A4

    # ── Phase 3-A: 클라이맥스 질주 ───────────────────────────────────────────
    (494, _E), (554, _E), (587, _E), (659, _E),   # B4  C#5 D5  E5
    (740, _E), (784, _E), (880, _E), (784, _E),   # F#5 G5  A5  G5
    (740, _E), (659, _E), (587, _E), (554, _E),   # F#5 E5  D5  C#5
    (494, _E), (440, _E), (392, _E), (330, _E),   # B4  A4  G4  E4

    # ── Phase 3-B: 주제 재현 + 종지 ──────────────────────────────────────────
    (370, _Q), (440, _Q), (494, _Q), (587, _Q),   # F#4 A4  B4  D5
    (740, _H),                                     # F#5 2분음표 (정점)
    (587, _W),                                     # D5  온음표 (종지)
]
del _Q, _E, _H, _W
